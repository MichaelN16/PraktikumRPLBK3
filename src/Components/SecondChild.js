...
class SecondChild extends React.Component {
    ...
    handleTotal = () => {
        const {caloriesTotalPagi,caloriesTotalSiang,caloriesTotalMalam,} = this.state 
        this.setState({caloriesTotal: caloriesTotalPagi + caloriesTotalSiang + caloriesTotalMalam})
    }
    handleCalculation = () => {
        const {
            sarapan1,
